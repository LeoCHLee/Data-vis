    ...
    dcc.Tabs(id="tabs", value='tab-1', children=[
        ...
        dcc.Tab(label="Power Plants Map", value='tab-1', children=[
            html.Div(id="legend-container", children=[
                ...
                *(  # Wrap the comprehension target in parentheses with the unpacking operator (*)
                    html.Div([
        ...
        # Second Tab: Renewable Energy Map
        dcc.Tab(label="Renewable Energy Map", value='tab-2', children=[
            dcc.Graph(figure=fig2, style={"height": "90vh"})
        ]),

        # Third Tab: Pie Chart and Another Graph
        dcc.Tab(label="Pie Chart and Another Graph", value='tab-3', children=[
            html.Div([
            ...
            #     # Right Section: Placeholder Graph
            #     html.Div([
            #         html.Label("Unrelated Graph (Placeholder)", style={'fontSize': '18px', 'textAlign': 'center'}),
            #         dcc.Graph(id='another-graph', style={'height': '400px', 'marginTop': '20px'}),
            #     ], style={'width': '45%', 'display': 'inline-block', 'padding': '10px'})
            ])
        ])
    ])
...
#         title=f"Placeholder Bar Graph for {selected_country}"
#     )
#     return fig
